<div class="col-2">
    <h4 class="mb-4">{{__('Theme (Job)')}}</h4>

    <x-colorpicker.input value="{{get_static_option($suffix.'_main_color_one','#2C62F6')}}" name="{{$suffix}}_main_color_one" label="{{__('Site Main Color One')}}"/>
    <x-colorpicker.input value="{{get_static_option($suffix.'_main_color_one_rgb','44, 98, 246')}}" name="{{$suffix}}_main_color_one_rgb" label="{{__('Site Main Color One RGB')}}"/>
    ...
    <x-colorpicker.input value="{{get_static_option($suffix.'_btn_color_one','#2C62F6')}}" name="{{$suffix}}_btn_color_one" label="{{__('Site Button Color One')}}"/>
    ...
    <x-colorpicker.input value="{{get_static_option($suffix.'_section_bg_one','#F9F9F9')}}" name="{{$suffix}}_section_bg_one" label="{{__('Site Section Background One')}}"/>
    ...
    <x-colorpicker.input value="{{get_static_option($suffix.'_paragraph_color','#17171')}}" name="{{$suffix}}_paragraph_color" label="{{__('Site Paragraph Color')}}"/>
