<div class="col-2">
    <h4 class="mb-4">{{__('Theme (Portfolio)')}}</h4>

    <x-colorpicker.input value="{{get_static_option($suffix.'_main_color_one','#c37236')}}" name="{{$suffix}}_main_color_one" label="{{__('Site Main Color One')}}"/>
    <x-colorpicker.input value="{{get_static_option($suffix.'_main_color_one_rgb','195, 114, 54')}}" name="{{$suffix}}_main_color_one_rgb" label="{{__('Site Main Color One RGB')}}"/>
    <x-colorpicker.input value="{{get_static_option($suffix.'_secondary_color','#fde5b5')}}" name="{{$suffix}}_secondary_color" label="{{__('Site Secondary Color ')}}"/>
    <x-colorpicker.input value="{{get_static_option($suffix.'_secondary_color_rgb','253, 229, 181')}}" name="{{$suffix}}_secondary_color_rgb" label="{{__('Site Secondary Color RGB')}}"/>

    <x-colorpicker.input value="{{get_static_option($suffix.'_section_bg','#353543')}}" name="{{$suffix}}_section_bg" label="{{__('Portfolio Section Background Color')}}"/>
    <x-colorpicker.input value="{{get_static_option($suffix.'_section_bg_2','#DDDDDD')}}" name="{{$suffix}}_section_bg_2" label="{{__('Portfolio Section Background Two Color')}}"/>
    <x-colorpicker.input value="{{get_static_option($suffix.'_section_bg_3','#f1f1f1')}}" name="{{$suffix}}_section_bg_3" label="{{__('Portfolio Section Background Three Color')}}"/>
