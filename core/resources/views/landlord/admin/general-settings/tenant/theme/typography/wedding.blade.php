...
@if(get_static_option('tenant_default_theme') == 'wedding')
<div class="col-4">
    <h4 class="mb-4 text-primary">{{__('Theme (Wedding)')}}</h4>
    ...
    <h4 class="header-title margin-top-80 mt-3">{{__("Heading Font (Wedding)")}}</h4>
    <div class="form-group">
