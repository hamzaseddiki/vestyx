<div class="col-2">
    <h4 class="mb-4">{{__('Theme (Wedding)')}}</h4>

    <x-colorpicker.input value="{{get_static_option($suffix.'_main_color_one','#fe6866')}}" name="{{$suffix}}_main_color_one" label="{{__('Site Main Color One')}}"/>
    <x-colorpicker.input value="{{get_static_option($suffix.'_main_color_one_rgb','254, 104, 102')}}" name="{{$suffix}}_main_color_one_rgb" label="{{__('Site Main Color One RGB')}}"/>
    <x-colorpicker.input value="{{get_static_option($suffix.'_secondary_color','#fe7596')}}" name="{{$suffix}}_secondary_color" label="{{__('Site Secondary Color ')}}"/>
    <x-colorpicker.input value="{{get_static_option($suffix.'_secondary_color_rgb','254, 117, 150')}}" name="{{$suffix}}_secondary_color_rgb" label="{{__('Site Secondary Color RGB')}}"/>

    <x-colorpicker.input value="{{get_static_option($suffix.'_section_bg_secondary','#452b4e')}}" name="{{$suffix}}_section_bg_secondary" label="{{__('Wedding Secondary Background Color')}}"/>
    <x-colorpicker.input value="{{get_static_option($suffix.'_section_bg','#FFFAF0')}}" name="{{$suffix}}_section_bg" label="{{__('Wedding Section Background Color')}}"/>
    <x-colorpicker.input value="{{get_static_option($suffix.'_section_bg_2','#F9F9F9')}}" name="{{$suffix}}_section_bg_2" label="{{__('Wedding Secondary Background Two Color')}}"/>
    <x-colorpicker.input value="{{get_static_option($suffix.'_section_bg_3','#f1f1f1')}}" name="{{$suffix}}_section_bg_3" label="{{__('Wedding Section Background Three Color')}}"/>
