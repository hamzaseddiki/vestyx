...
@if(get_static_option('tenant_default_theme') == 'software-business')

<div class="col-4">
    <h4 class="mb-4 text-primary">{{__('Theme (Software Business)')}}</h4>
    ...
    <h4 class="header-title margin-top-80 mt-3">{{__("Heading Font (Photography)")}}</h4>
    <div class="form-group">
