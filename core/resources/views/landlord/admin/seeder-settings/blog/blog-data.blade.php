                    ...
                    <div class="card-body">
                        <x-admin.header-wrapper>
                            ...
                            <x-slot name="right" class="d-flex">
                                ...
                                <x-link-with-popover  url="{{route('landlord.admin.seeder.blog.index')}}" extraclass="ml-3">
                                    {{__('Go Back')}}
                                </x-link-with-popover>
                            ...
                            <table class="table table-default table-striped table-bordered">
                                ...
                                @foreach($all_data_decoded->data ?? [] as $data)
                                    @php
                                        ...
                                        $description_decoded = (array) json_decode(get_data_without_extra_space_or_new_line($data->blog_content)) ?? [];
                                    @endphp
                                    <tr>
