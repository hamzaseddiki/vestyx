                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <x-admin.header-wrapper>
                            <x-slot name="left">
                                <h4 class="header-title">{{__('Faq Category Demo Data')}}</h4>
                            </x-slot>
                            <x-slot name="right" class="d-flex">
                              ...
                              <p></p>
                                ...
                                <x-link-with-popover  url="{{route('landlord.admin.seeder.faq.index')}}" extraclass="ml-3">
                                    {{__('Go Back')}}
                                </x-link-with-popover>
