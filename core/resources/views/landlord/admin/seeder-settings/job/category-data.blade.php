                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <x-admin.header-wrapper>
                            <x-slot name="left">
                                <h4 class="header-title">{{__('Job Category Demo Data')}}</h4>
                            </x-slot>
                        ...
                        <div class="table-wrap table-responsive">
                            ...
                            @foreach($all_data_decoded->data ?? [] as $data)
                                @php
                                    ...
                                    $subtitle_decoded = (array) json_decode($data->subtitle) ?? [];
                                @endphp
                                <tr>
                                    <td>{{ $loop->iteration }}</td>
                                    <td>{!! $title_decoded[$lang_slug] ?? '' !!}</td>
                                    <td>{{ $subtitle_decoded[$lang_slug] ?? '' }}</td>
                                    <td>
                                        <a href="#"
                                           data-id="{{$data->id}}"
                ...
                <form action="" method="post" enctype="multipart/form-data" class="donation_category_seeder_edit_form">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="subtitle" class="form-control subtitle" rows="5"></textarea>
                        </div>
                    </div>
