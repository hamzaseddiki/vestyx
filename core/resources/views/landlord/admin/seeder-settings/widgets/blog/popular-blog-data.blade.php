...
@section('title')
    {{__('Popular Blog Widget Demo Data')}}
@endsection
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <x-admin.header-wrapper>
                            <x-slot name="left">
                                <h4 class="header-title">{{__('Popular Blog Widget Demo Data')}}</h4>
                            </x-slot>
                        ...
                        <div class="table-wrap table-responsive">
                            <table class="table table-default table-striped table-bordered">
                                ...
                                <tr>
                                    <td>{{ $all_data_decoded['id'] ?? 1}}</td>
                                    <td>{!! $all_data_decoded['heading_text_'.$lang_slug] ?? '' !!}</td>
                                    <td>
                                        <a href="#"
                                           data-id="{{$all_data_decoded['id'] ?? ''}}"
                                           data-title="{!! $all_data_decoded['heading_text_'.$lang_slug]  ?? '' !!}"
                ...
                <form action="" method="post" enctype="multipart/form-data" class="donation_category_seeder_edit_form">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            <label for="order_status">{{__('Heading')}}</label>
