...
@section('title')
    {{__('Subscribe Newsletter Widget Demo Data')}}
@endsection
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <x-admin.header-wrapper>
                            <x-slot name="left">
                                <h4 class="header-title">{{__('Subscribe Newsletter Widget Demo Data')}}</h4>
                            </x-slot>
                        ...
                        <div class="table-wrap table-responsive">
                            <table class="table table-default table-striped table-bordered">
                                ...
                                <tr>
                                    ...
                                    <td>{!! $all_data_decoded['heading_text_'.$lang_slug] ?? '' !!}</td>
                                    <td>{!! \Illuminate\Support\Str::words($all_data_decoded['description_'.$lang_slug] ?? '',15) !!}</td>
                                    <td>
                                        <a href="#"
                                           data-id="{{$all_data_decoded['id']}}"
                                           data-heading_text="{!! $all_data_decoded['heading_text_'.$lang_slug]  ?? '' !!}"
                ...
                <form action="" method="post" enctype="multipart/form-data" class="donation_category_seeder_edit_form">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="heading_text" class="form-control heading_text">
                        </div>
    ...
    <script>
        $(document).ready(function($){
            ...
            $(document).on('click','.donation_category_seeder_edit_btn',function(){
                ...
                let id = el.data('id');
                let heading_text = el.data('heading_text');
                let description = el.data('description');

                form.find('.category_id').val(id);
                form.find('.heading_text').val(heading_text);
