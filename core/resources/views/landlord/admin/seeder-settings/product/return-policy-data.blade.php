...
@section('title')
    {{__('Product Shipping & Return Policy Demo Data')}}
@endsection
                ...
                <div class="card">
                    <div class="card-body">
                        <x-admin.header-wrapper>
                            <x-slot name="left">
                                <h4 class="header-title">{{__('Shipping & Return Policy Demo Data')}}</h4>
                            </x-slot>
                        ...
                        <div class="table-wrap table-responsive">
                            <table class="table table-default table-striped table-bordered">
                                ...
                                @foreach($all_data_decoded->data ?? [] as $data)
                                    @php
                                        $description_decoded = (array) json_decode(get_data_without_extra_space_or_new_line($data->shipping_return_description)) ?? [];
                                    @endphp
                                    <tr>
