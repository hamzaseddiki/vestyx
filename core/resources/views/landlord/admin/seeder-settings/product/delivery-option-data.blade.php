...
@section('title')
    {{__('Product Delivery Option Demo Data')}}
@endsection
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <x-admin.header-wrapper>
                            <x-slot name="left">
                                <h4 class="header-title">{{__('Product Delivery Option Demo Data')}}</h4>
                            </x-slot>
                        ...
                        <div class="table-wrap table-responsive">
                            ...
                            @foreach($all_data_decoded->data ?? [] as $data)
                                ...
                                @php
                                    ...
                                    $subtitle_decoded = (array) json_decode($data->sub_title) ?? [];
                                @endphp
                ...
                <form action="" method="post" enctype="multipart/form-data" class="donation_category_seeder_edit_form">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="sub_title" class="form-control subtitle">
                        </div>
