    ...
    <figure class="cartProduct-wrapper mb-50">
       ...
       @endphp
        ...
        <div class="btn-wrapper">
            <a href="{{url('shop')}}" class="barberShop_cmn_btn btn_outline_1 color_one radius-5 w-100 mb-10">{{__('Continue Shopping')}}</a>
            <a href="{{route('tenant.shop.cart')}}" class="barberShop_cmn_btn btn_bg_1 radius-5 w-100 mb-10">{{__('View Shopping Cart')}}</a>
            <a href="{{route('tenant.shop.checkout')}}" class="barberShop_cmn_btn btn_bg_2 color_two radius-5 w-100">{{__('Go to Checkout')}}</a>
        </div>
    </figure>
</div>
