        ...
        <div class="cart-total-table table-responsive">
            <table class="table table-bordered">
                ...
                <tr>
                    ...
                    <td>
                        <p>{{__('Country')}} : {{$payment_details->getCountry?->name}}</p>
                        <p>{{ __('State') }}: {{$payment_details->getState?->name}}</p>
                        <p>{{__('City')}} : {{$payment_details->city}}</p>
{{--                        <p>{{__('Zip Code')}} : {{$payment_details->zipcode}}</p>--}}

                        <p>{{__('Address')}} : {{$payment_details->address}}</p>
                    </td>
                </tr>
                <tr>
