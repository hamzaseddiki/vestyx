...
<div class="mail-container">
    ...
    <div class="message-box">
        @php
            ...
            $message = str_replace('@company',get_static_option('site_'.get_user_lang().'_title'),$message);
        @endphp
        {!! $message !!}
    </div>
    <footer>
        &copy; All Right Reserved By {{get_static_option('site_'.get_user_lang().'_title')}}
    </footer>
</div>
</body>
</html>
