                    ...
                    <div class="capDetails2  mb-10">
                        ...
                        <div class="caption">
                            <ul class="postInfo mb-30">
                                ...
                                <a href="{{ route('tenant.frontend.donation.activities.category',['id' =>$activites->category_id, 'any' => \Illuminate\Support\Str::slug($activites->category?->getTranslation('title',get_user_lang())) ]) }}">
