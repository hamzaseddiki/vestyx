...
<div class="testimonialarea-global section-padding2 sectionBg1-global" data-padding-top="{{$data['padding_top']}}" data-padding-bottom="{{$data['padding_bottom']}}">
    <div class="container">
        <!-- Section Tittle -->
        <div class="row">
            <div class="col-xxl-7 col-xl-7 col-lg-8 col-md-9 col-sm-10">
                <div class="section-tittle mb-50">
                    <h2 class="tittle">{{$data['title']}}
                    </h2>
                </div>
            </div>
        </div>
        <div class="row">
            <div class="col-lg-12">
                <div class="global-slick-init slider-inner-margin arrowStyleThree" data-arrows="true" data-dots="false" data-slidesToShow="3" data-swipeToSlide="true" data-autoplay="true" data-autoplaySpeed="2500" data-prevArrow='<div class="prev-icon"><i class="las fa-angle-left"></i></div>'
                    ...
                    @foreach($data['testimonial'] as $data)
                     <div class="singleTestimonial-global">
                        <div class="testiPera">
