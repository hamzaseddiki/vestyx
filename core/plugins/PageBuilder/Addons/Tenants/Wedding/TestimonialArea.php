...
class TestimonialArea extends PageBuilderBase
{
    ...
    {
        return 'Tenant/Wedding/testimonial-area.png';
    }
    ...
    public function admin_render()
    {
        ...
        foreach ($all_languages as $key => $lang) {
            ...
            $output .= Text::get([
                'name' => 'inner_text_'.$lang->slug,
                'label' => __('Inner Text'),
                'value' => $widget_saved_values['inner_text_'.$lang->slug] ?? null,
            ]);
    ...
    public function frontend_render()
    {
        ...
        $inner_text = $this->setting_item('inner_text_'.$current_lang) ?? '';
        ...
        return self::renderView('tenant.wedding.testimonial-area',$data);
    ...
    {
        return __('Testimonial Area (Wedding)');
    }
}
