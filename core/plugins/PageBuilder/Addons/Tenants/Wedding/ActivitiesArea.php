...
class ActivitiesArea extends PageBuilderBase
{

    public function preview_image()
    {
        return 'Tenant/Wedding/activities-area.png';
    }
    ...
    public function admin_render()
    {
        ...
        $output .= Repeater::get([
            ...
            'id' => 'wedding_activities_area_repeater',
            'fields' => [
                [
    ...
    public function frontend_render()
    {
        ...
        $repeater_data = $this->setting_item('wedding_activities_area_repeater');
        ...
        return self::renderView('tenant.wedding.activities-area',$data);
    }
    ...
    {
        return __('Activities Area (Wedding)');
    }
}
