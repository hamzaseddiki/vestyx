...
class EventSubscribeNewsletter extends PageBuilderBase
{

    public function preview_image()
    {
        return 'Tenant/Event/event-subscribe-newsletter.png';
    }
    ...
    public function frontend_render()
    {
        ...
        return self::renderView('tenant.event.event-subscribe-newsletter',$data);
    }
    ...
    {
        return __('Event Subscribe Newsletter');
    }
}
