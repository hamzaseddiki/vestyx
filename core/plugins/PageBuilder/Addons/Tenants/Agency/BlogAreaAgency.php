...
class BlogAreaAgency extends PageBuilderBase
{

    public function preview_image()
    {
        return 'Tenant/Agency/blog-area.png';
    }
    ...
    public function frontend_render()
    {
        ...
        return self::renderView('tenant.agency.blog-area',$data);
