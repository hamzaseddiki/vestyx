...
class HeaderSlider extends PageBuilderBase
{
    ...
    public function admin_render()
    {
        ...
        $output.= Image::get([
            ...
            'value' => $widget_saved_values['bg_image'] ?? '',
            'dimensions' => '(1920*970)'
        ]);
        ...
        $output .= Repeater::get([
            ...
            'id' => 'donation_header_slider_repeater',
            'fields' => [
                [
                ...
                [
                    'type' => RepeaterField::TEXT,
                    'name' => 'repeater_bottom_right_text',
                    'label' => __('Bottom Right Text')
                ],
                [
                    'type' => RepeaterField::TEXT,
                    'name' => 'repeater_bottom_right_url',
                    'label' => __('Bottom Right URL')
                ],
                [
                    'type' => RepeaterField::IMAGE,
                    'name' => 'repeater_right_image',
                    'label' => __('Right Image'),
                    'dimensions'=> __('(636*475)')
                ],
    ...
    public function frontend_render()
    {
        ...
        $repeater_data = $this->setting_item('donation_header_slider_repeater') ?? [];
        ...
        return self::renderView('tenant.donation.header-slider',$data);
    }
    ...
    {
        return __('Header Slider (Donation)');
    }
}
