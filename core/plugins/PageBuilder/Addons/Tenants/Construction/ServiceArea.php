...
class ServiceArea extends PageBuilderBase
{
    ...
    {
        return 'Tenant/Construction/service-area.png';
    }
    ...
    public function admin_render()
    {
        ...
        $output .= Repeater::get([
            ...
            'multi_lang' => true,
            'id' => 'construction_service_repeater',
            'fields' => [
                [
    ...
    public function frontend_render()
    {
        ...
        $repeater_data = $this->setting_item('construction_service_repeater');
        ...
        return self::renderView('tenant.construction.service-area',$data);
    }
    ...
    {
        return __('Service Area (Construction)');
    }
}
