...
class TestimonialArea extends PageBuilderBase
{
    ...
    {
        return 'Tenant/Construction/testimonial-area.png';
    }
    ...
    public function admin_render()
    {
        ...
        $output .= Select::get([
            ...
            'label' => __('Order'),
            'options' => [
                'construction' => __('Style One'),
                'consultancy' => __('Style Two'),
            ]
        ]);
    ...
    public function frontend_render()
    {
        ...
        $heading_style = SanitizeInput::esc_html($this->setting_item('heading_style'));
        ...
        return self::renderView('tenant.construction.testimonial-area',$data);
    }
    ...
    {
        return __('Testimonial (Construction)');
    }
}
