...
class WorkArea extends PageBuilderBase
{
    ...
    {
        return 'Tenant/BarberShop/work-area.png';
    }
            ...
            'fields' => [
                ...
                [
                    ...
                    'options' => [
                        ...
                        'semi-horizontal' => __('Semi Horizontal'),
    ...
    public function frontend_render()
    {
        ...
        $repeater_data = $this->setting_item('barber_work_area_repeater');
        ...
        return self::renderView('tenant.barber-shop.work-area',$data);
    }
    ...
    {
        return __('Work Area (Barber Shop)');
    }
}
