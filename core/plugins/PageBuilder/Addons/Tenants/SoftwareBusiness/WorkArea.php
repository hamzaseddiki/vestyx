...
class WorkArea extends PageBuilderBase
{
    ...
    {
        return 'Tenant/SoftwareBusiness/work-area.png';
    }
    ...
    public function admin_render()
    {
        ...
        $output .= Repeater::get([
            ...
            'multi_lang' =>true,
            'id' => 'software_business_work_area_repeater',
            'fields' => [
                [
    ...
    public function frontend_render()
    {
        ...
        $repeater_data = $this->setting_item('software_business_work_area_repeater');
        ...
        return self::renderView('tenant.software-business.work-area',$data);
    }
