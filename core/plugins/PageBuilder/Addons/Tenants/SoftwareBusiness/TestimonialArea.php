...
class TestimonialArea extends PageBuilderBase
{
    ...
    {
        return 'Tenant/SoftwareBusiness/testimonial-area.png';
    }
    ...
    public function frontend_render()
    {
        ...
        return self::renderView('tenant.software-business.testimonial-area',$data);
    ...
    {
        return __('Testimonial Area (Software)');
    }
}
