...
class StoryArea extends PageBuilderBase
{

    public function preview_image()
    {
        return 'Tenant/Photography/story-area.png';
    }
    ...
    public function frontend_render()
    {
        ...
        $repeater_data = $this->setting_item('photography_story_repeater');
        ...
        return self::renderView('tenant.photography.story-area',$data);
    }
    ...
    {
        return __('Story Area (Photography)');
    }
}
