...
class ServiceArea extends PageBuilderBase
{
    ...
    {
        return 'Tenant/Photography/service-area.png';
    }
    ...
    public function admin_render()
    {
        ...
        $output .= Repeater::get([
            ...
            'multi_lang' => true,
            'id' => 'photography_service_area_repeater',
            'fields' => [
                [
    ...
    public function frontend_render()
    {
        ...
        $repeater_data = $this->setting_item('photography_service_area_repeater');
        ...
        return self::renderView('tenant.photography.service-area',$data);
    }
    ...
    {
        return __('Service Area (Photography)');
    }
}
