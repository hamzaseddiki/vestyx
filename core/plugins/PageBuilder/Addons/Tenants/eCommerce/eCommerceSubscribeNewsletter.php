...
class eCommerceSubscribeNewsletter extends PageBuilderBase
{

    public function preview_image()
    {
        return 'Tenant/eCommerce/ecommerce-subscribe-newsletter.png';
    }
    ...
    public function frontend_render()
    {
        ...
        return self::renderView('tenant.eCommerce.ecommerce-subscribe-newsletter',$data);
    }
    ...
    {
        return __('eCommerce Subscribe Newsletter');
    }
}
