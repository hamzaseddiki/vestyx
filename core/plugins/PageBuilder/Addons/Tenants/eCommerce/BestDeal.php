...
class BestDeal extends PageBuilderBase
{

    public function preview_image()
    {
        return 'Tenant/eCommerce/best-deal.png';
    }
    ...
    public function admin_render()
    {
        ...
        $output .= Repeater::get([
            ...
            'multi_lang' => true,
            'id' => 'eCommerce_best_deal_repeater',
            'fields' => [
                [
    ...
    public function frontend_render()
    {
        ...
        return self::renderView('tenant.eCommerce.best-deal',$data);
    }
