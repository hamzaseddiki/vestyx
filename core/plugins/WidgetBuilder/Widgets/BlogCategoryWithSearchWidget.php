...
class BlogCategoryWithSearchWidget extends WidgetBase
{
    ...
    public function frontend_render()
    {
        ...
        foreach ($blog_categories as $item){
            ...
            $form_action = route(route_prefix().'frontend.blog.search');
            $url = route(route_prefix().'frontend.blog.category', ['id' => $item->id,'any' => Str::slug($title)]);
...
HTML;
    ...
    {
        return __('Blog Category & Search');
    }
}
