...
HTML;
    ...
    public static function viewAttachment($data){
        ...
        $image_url = url('assets/uploads/job-applications/'.$data->manual_payment_attachment);
        return <<<HTML
...
HTML;
    ...
    public static function viewResumeAttachment($data){

        $image_url = url('assets/uploads/job-applications/'.$data->resume);
        return <<<HTML
    <a href="{$image_url}" class="btn btn-info btn-xs mb-3 mr-1 " target="_blank">
      View Resume
    </a>
