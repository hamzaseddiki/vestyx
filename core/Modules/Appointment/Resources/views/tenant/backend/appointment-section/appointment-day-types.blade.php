    ...
    <div class="col-12 grid-margin stretch-card">
        <div class="card">
            <div class="card-body">
                <x-admin.header-wrapper>
                    <x-slot name="left">
                        <h4 class="card-title mb-5">{{__('All Appointment Day Types')}}</h4>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="#"
                                       ...
                                       title="{{__('Edit')}}"
                                       data-id="{{$data->id}}"
                                       data-action="{{route('tenant.admin.appointment.day.types.update')}}"
                                    ...
                                    <x-delete-popover permissions="donation-category-delete" url="{{route('tenant.admin.appointment.day.types.delete', $data->id)}}"/>
                                </td>
                            </tr>
                        @endforeach
                    </x-slot>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="staticBackdropLabel">{{__('New Type')}}</h5>
                        <button type="button" class="btn-close btn-sm" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <form action="{{route('tenant.admin.appointment.day.types')}}" method="post" enctype="multipart/form-data">
        ...
        <div class="modal fade" id="testimonial_item_edit_modal" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="staticBackdropLabel">{{__('Edit Item')}}</h5>
...
@section('scripts')
    ...
    <script>
        $(document).ready(function($){
            ...
            <x-bulk-action-js :url="route( 'tenant.admin.appointment.day.types.bulk.action')"/>
