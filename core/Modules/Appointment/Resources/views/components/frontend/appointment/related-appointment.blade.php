...
<div class="row padding-top-70">
    <div class="col-xl-12">
        <div class="section-tittle mb-30">
            <h2 class="tittle">{{__('Related Appointment')}}</h2>
        </div>
    </div>

    @foreach($allRelatedAppointments as $data)
        <div class="col-lg-4 col-md-6 ">
            <figure class="singleBlog-global mb-24">
                <div class="blog-img overlay1">
                    <a href="{{route(route_prefix().'frontend.appointment.single',$data->slug)}}">
                ...
                <figcaption class="blogCaption">
                    ...
                    <p class="pera mb-4">{!! \Illuminate\Support\Str::words($data->getTranslation('description',get_user_lang()),40) !!}</p>
                    <br>
                </figcaption>
            </figure>
        </div>
