                ...
                <div class="global-flex-card">
                    <div class="global-card-thumb global-flex-card-thumb"
                        ...
                        <div class="global-card-thumb-badge right-side">
                            ...
                            @if(!empty($product->badge))
                                <span
                                    class="global-card-thumb-badge-box bg-color-new"> {{$product?->badge?->getTranslation('name',get_user_lang())}} </span>
                            @endif
                    ...
                    <div class="global-flex-card-contents">
                        ...
                        <h5 class="global-flex-card-contents-title fw-500 mt-3">
                            <a href="{{route('tenant.shop.product.details', $product->slug)}}"> {{Str::words($product->getTranslation('name',get_user_lang()), 8)}} </a>
                        </h5>
                        ...
                        <p class="global-flex-card-contents-para extra-padding-right mt-4"> {{Str::words($product->getTranslation('summary',get_user_lang()), 30)}} </p>
                        <div class="global-flex-card-contents-bottom border-flex-card pt-4 mt-4 pt-lg-5 mt-lg-5">
                            <div class="global-flex-card-contents-icon">
                                ...
                                <div class="icon-list" data-bs-toggle="tooltip" data-bs-placement="top" title="Preview"
                                     data-id="{{$product->id}}"
                                     data-name="{{$product->getTranslation('name',get_user_lang())}}"
                                     data-category="{{$product?->category->getTranslation('name',get_user_lang())}}"
                                     data-subCategory="{{$product->subCategory?->getTranslation('name',get_user_lang())}}"
