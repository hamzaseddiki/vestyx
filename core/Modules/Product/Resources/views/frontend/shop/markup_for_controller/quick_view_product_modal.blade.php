...
<div class="col-lg-6 col-xl-6">
    <div class="single-shop-details-wrapper">
        <h2 class="details-title"> {{$product->getTranslation('name',get_user_lang())}} </h2>
        ...
        <div class="wishlist-compare mt-4">
            ...
            <div class="wishlist-share">
                ...
                {!! single_post_share($product->slug, $product->getTranslation('name',get_user_lang()), $product_primary_image) !!}
            </div>
        </div>
        <div class="shop-details-stock shop-border-top pt-4 mt-4">
            <ul class="stock-category">
                <li class="category-list">
                    ...
                    <a class="list-item fw-600" href="javascript:void(0)"> {{$product?->category?->getTranslation('name',get_user_lang())}} </a>
                </li>
                <li class="category-list">
                    <span> {{__('Sub Category:')}} </span>
                    <a class="list-item fw-600" href="javascript:void(0)"> {{$product?->subCategory?->getTranslation('name',get_user_lang())}} </a>
                </li>
                <li class="category-list">
                    <span> {{__('Child Category:')}} </span>
                    @foreach($product->childCategory ?? [] as $child_category)
                        <a class="list-item fw-600" href="javascript:void(0)"> {{$child_category->getTranslation('name',get_user_lang())}} </a>
                    @endforeach
                </li>
                <li class="category-list">
                    <span> {{__('SKU:')}} </span>
