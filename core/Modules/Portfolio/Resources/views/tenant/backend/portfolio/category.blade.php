...
@section('title') {{__('All Portfolio Category')}} @endsection
        ...
        <div class="card">
            <div class="card-body">
                <x-admin.header-wrapper>
                    <x-slot name="left">
                        <h4 class="card-title mb-5">{{__('All Portfolio Category')}}</h4>
                            ...
                            <tr>
                                ...
                                @can('portfolio-category-edit')
                                    <a href="#"
                                       ...
                                       title="{{__('Edit')}}"
                                       data-id="{{$data->id}}"
                                       data-action="{{route('tenant.admin.portfolio.category.update')}}"
                                    ...
                                    @endcan
                                    <x-delete-popover permissions="portfolio-category-delete" url="{{route('tenant.admin.portfolio.category.delete', $data->id)}}"/>
                                </td>
                            </tr>
                        @endforeach
                    </x-slot>
        ...
        <div class="modal fade" id="new_testimonial" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <form action="{{route('tenant.admin.portfolio.category')}}" method="post" enctype="multipart/form-data">
    ...
    @can('portfolio-category-edit')
        <div class="modal fade" id="testimonial_item_edit_modal" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="staticBackdropLabel">{{__('Edit Portfolio Item')}}</h5>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
