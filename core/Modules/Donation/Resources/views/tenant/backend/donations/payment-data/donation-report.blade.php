            ...
            <div class="col-12 mt-5">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="{{route('tenant.admin.donation.payment.logs.report')}}" method="get" enctype="multipart/form-data" id="report_generate_form">
                                ...
                                <div class="col-lg-2">
                                    <div class="form-group">
                                        ...
                                        <select name="status" id="order_status" class="form-control">
                                            ...
                                            <option @if( $payment_status == 0) selected @endif value="pending">{{__('Pending')}}</option>
                                            <option @if( $payment_status ==  1) selected @endif value="complete">{{__('Complete')}}</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="col-lg-2">
