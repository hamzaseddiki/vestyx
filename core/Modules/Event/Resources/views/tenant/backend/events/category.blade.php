...
@section('title') {{__('All Events Category')}} @endsection
        ...
        <div class="card">
            <div class="card-body">
                <x-admin.header-wrapper>
                    <x-slot name="left">
                        <h4 class="card-title mb-5">{{__('All Events Category')}}</h4>
                    <x-bulk-action permissions="event-category-delete"/>
                    </x-slot>
        ...
        <div class="modal fade" id="new_testimonial" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <form action="{{route('tenant.admin.event.category')}}" method="post" enctype="multipart/form-data">
    ...
    @can('donation-category-edit')
        <div class="modal fade" id="testimonial_item_edit_modal" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="staticBackdropLabel">{{__('Edit Events Item')}}</h5>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
...
@section('scripts')
    ...
    <script>
        $(document).ready(function($){
            ...
            <x-bulk-action-js :url="route( 'tenant.admin.event.category.bulk.action')"/>
